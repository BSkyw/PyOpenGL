...
def drawTriangle(program, style):
    ...
    glDrawArrays(GL_TRIANGLE_FAN, 0, 4)    #GL_TRIANGLE_FAN 头尾相连  GL_TRIANGLE_STRIP 头尾不相连
...
glutIdleFunc(drawTriangle(program,input("请输入rect or diamond：")))
 # 主循环
glutMainLoop()
